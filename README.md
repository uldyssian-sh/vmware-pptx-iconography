...
<img width="1645" height="877" alt="481363001-5dc59550-e33d-4d08-b74e-12118dca1b7d" src="https://github.com/user-attachments/assets/41873bad-5d16-4edb-b002-7866196c54b0" />

---

## 🗂 Icon Categories

These icons are grouped by theme:

| 🏷️ Theme | 📌 Examples / Notes |
|---|---|
| 👥 People | Icons depicting users, figures, teams |
| ♿ Disabilities | Accessibility-related icons |
| 🔄 Migration & Recovery | Restore, migration, backup, etc. |
| 💻 Devices & Hardware | Laptops, servers, smartphones |
| ☁️ Clouds & Infrastructure | Cloud, data center, virtual networks |
| 🤖 AI | Machine learning, analytics |
| 📱 Applications | App icons, UI elements |
| 🌐 Networking | Routers, switches, connections |
| 🏢 Data Centers | Racks, servers, cooling, power |
| ☁️ VMware Cloud Providers | Hybrid / multi-cloud |
| 📈 Tanzu Observability | Monitoring, logs, dashboards |
| 🛠 Tools & Processes | Gears, workflows, metrics |
| 💼 Business | Finance, sales, operations |
| 📡 Telco | Telecom-specific |
| 🔒 Security | Locks, shields, secure access |
| 🏭 Industries | Industry-specific symbols |
| 📦 Other Products | VMware’s other solutions |
| 📀 vSAN Icons | Storage, virtualization, data |

<img width="1724" height="957" alt="481363015-9057f216-6459-47c8-ae1e-162b29af9925" src="https://github.com/user-attachments/assets/9ba357ce-3e0d-4970-ac33-dc26a1046f56" />
